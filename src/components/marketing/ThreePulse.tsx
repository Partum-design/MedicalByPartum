  ...
  return (
    <group ref={group}>
      <mesh rotation={[Math.PI / 2, 0, 0]}>
        ...
        <meshBasicMaterial color="#00ffb3" transparent opacity={0.82} />
      </mesh>
      <mesh rotation={[Math.PI / 2, 0.6, 0]}>
        <torusGeometry args={[1.32, 0.012, 12, 96]} />
        <meshBasicMaterial color="#6ee7f2" transparent opacity={0.4} />
      </mesh>
      <mesh>
      ...
      <pointLight color="#00ffb3" intensity={2} distance={4} />
    </group>
  );
}
